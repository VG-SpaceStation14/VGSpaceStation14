...
public sealed partial class GasLeakRuleComponent : Component
{
    ...
    public readonly int MinimumMolesPerSecond = 50; // VG-tweak

    /// <summary>
    ///     Don't want to make it too fast to give people time to flee.
    /// </summary>
    public int MaximumMolesPerSecond = 100; // VG-tweak

    public int MinimumGas = 250; // VG-tweak
    public int MaximumGas = 2000; // VG-tweak

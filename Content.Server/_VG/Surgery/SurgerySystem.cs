...
using Content.Shared._VG.Surgery.Effects.Step;
using Content.Shared._VG.Surgery.Tools;
using Content.Shared.Bed.Sleep;
using Content.Shared.Medical.Surgery;
using Content.Shared.Verbs;

namespace Content.Server._VG.Surgery;
...
public sealed class SurgerySystem : SharedSurgerySystem
{
    ...
    private void AttemptStartSurgery(Entity<SurgeryToolComponent> ent, EntityUid user, EntityUid target)
    {
        ...
        if (user == target) // TODO: Add CVar check for self-surgery when NextVars is available
    ...
    private void OnUtilityVerb(Entity<SurgeryToolComponent> ent, ref GetVerbsEvent<UtilityVerb> args)
    {
        ...
        var verb = new UtilityVerb()
        {
            ...
            Icon = new SpriteSpecifier.Rsi(new("/Textures/_VG/Objects/Specific/Medical/Surgery/scalpel.rsi/"), "scalpel"),

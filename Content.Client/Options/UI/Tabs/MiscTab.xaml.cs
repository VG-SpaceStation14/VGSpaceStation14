...
public sealed partial class MiscTab : Control
{
    ...
    public MiscTab()
    {
        ...
        // VG, EE - Chat stacking options for how far back in the chat to stack.
        ...
        Control.AddOptionDropDown<int>(CCVars.ChatStackLastLines, ChatStackLastLines, chatStackEntries); // VG, EE - Chat stacking

...
surgery-popup-procedure-SurgeryAttachRightHand-step-SurgeryStepInsertFeature = {$user} присоединяет правую ладонь к {$part} {$target}!
...
surgery-popup-step-SurgeryStepSealWounds = {$user} прижигает раны на {$part} {$target}.
...
surgery-popup-step-SurgeryStepCarefulIncisionScalpel = {$user} делает аккуратный разрез на {$part} {$target}.
surgery-popup-step-SurgeryStepRepairBruteTissue = {$user} лечит механические повреждения на {$part} {$target}!
surgery-popup-step-SurgeryStepRepairBurnTissue = {$user} лечит термические повреждения на {$part} {$target}!
surgery-popup-step-SurgeryStepSealTendWound = {$user} прижигает кровотечение на {$part} {$target}.
...
surgery-popup-step-SurgeryStepSealOrganWound = {$user} прижигает раны органа в {$part} {$target}.
surgery-popup-step-SurgeryStepMendBrainTissue = {$user} восстанавливает ткани мозга в {$part} {$target}.
surgery-popup-step-SurgeryStepLobotomize = {$user} выполняет трепанацию {$part} у {$target}.

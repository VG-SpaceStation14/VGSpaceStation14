...
skill-teach-too-far = Вы слишком далеко от ученика
skill-teach-not-known = Вы не знаете этот навык
skill-teach-already-known = Ученик уже знает этот навык
skill-teach-no-book = У вас нет книги этого навыка в руках
skill-teach-start-teacher = Вы начали обучать { $student } навыку { $skill }
skill-teach-start-student = { $teacher } начал обучать вас навыку { $skill }

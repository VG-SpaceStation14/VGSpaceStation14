...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<float> MinimumImpactInertia =
        CVarDef.Create("shuttle.impact.minimum_inertia", 25f, CVar.SERVERONLY); // VG-Tweak 50 -> 25 
    ...
    public static readonly CVarDef<float> MinimumImpactVelocity =
        CVarDef.Create("shuttle.impact.minimum_velocity", 3f, CVar.SERVERONLY); // VG-Tweak С 5 -> 3 
    /// <summary>
    ...
    public static readonly CVarDef<float> TileBreakEnergyMultiplier =
        CVarDef.Create("shuttle.impact.tile_break_energy", 100f, CVar.SERVERONLY); // VG-Tweak 500 -> 100 
    ...
    public static readonly CVarDef<float> ImpactDamageMultiplier =
        CVarDef.Create("shuttle.impact.damage_multiplier", 0.001f, CVar.SERVERONLY); // VG-Tweak 0.0002 -> 0.001 
    ...
    public static readonly CVarDef<float> ImpactStructuralDamage =
        CVarDef.Create("shuttle.impact.structural_damage", 1f, CVar.SERVERONLY); // VG-Tweak 2 -> 1 
    ...
    public static readonly CVarDef<float> SparkEnergy =
        CVarDef.Create("shuttle.impact.spark_energy", 50000f, CVar.SERVERONLY); // VG-Tweak 200000 -> 50000 
    ...
    public static readonly CVarDef<float> ImpactRadius =
        CVarDef.Create("shuttle.impact.radius", 2.5f, CVar.SERVERONLY); // VG-Tweak 3 -> 2.5
    ...
    public static readonly CVarDef<float> ImpactSlowdown =
        CVarDef.Create("shuttle.impact.slowdown", 3f, CVar.SERVERONLY); // VG-Tweak 5 -> 3
    ...
    public static readonly CVarDef<float> ImpactMinThrowVelocity =
        CVarDef.Create("shuttle.impact.min_throw_velocity", 0.5f, CVar.SERVERONLY); 
    ...
    public static readonly CVarDef<float> ImpactMassBias =
        CVarDef.Create("shuttle.impact.mass_bias", 0.4f, CVar.SERVERONLY); // VG-Tweak 0.5 -> 0.4
    ...
    public static readonly CVarDef<float> ImpactInertiaScaling =
        CVarDef.Create("shuttle.impact.inertia_scaling", 0.3f, CVar.SERVERONLY);

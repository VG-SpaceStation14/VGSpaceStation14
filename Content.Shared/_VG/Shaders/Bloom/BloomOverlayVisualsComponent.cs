...
{
    [ViewVariables]
    public static readonly SpriteSpecifier Cone = new Rsi(new ResPath("_VG/Effects/LightMasks/128.rsi"), "light_cone");
    [ViewVariables]
    ...
    [ViewVariables]
    public static readonly SpriteSpecifier Point = new Rsi(new ResPath("_VG/Effects/LightMasks/64.rsi"), "light_point");
    [ViewVariables]

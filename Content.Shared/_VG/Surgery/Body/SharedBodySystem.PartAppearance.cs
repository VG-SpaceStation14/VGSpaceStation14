...
public partial class SharedBodySystem
{
    ...
    private void InitializePartAppearances()
    {
        ...
        SubscribeLocalEvent<BodyComponent, Content.Shared._VG.Surgery.Body.Events.BodyPartAddedEvent>(OnPartAttachedToBody);
        SubscribeLocalEvent<BodyComponent, Content.Shared._VG.Surgery.Body.Events.BodyPartRemovedEvent>(OnPartDroppedFromBody);
    }
    ...
    private void OnPartAttachedToBody(EntityUid uid, BodyComponent component, ref Content.Shared._VG.Surgery.Body.Events.BodyPartAddedEvent args)
    {
    ...
    private void OnPartDroppedFromBody(EntityUid uid, BodyComponent component, ref Content.Shared._VG.Surgery.Body.Events.BodyPartRemovedEvent args)
    {
